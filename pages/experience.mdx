...
- Part of the bank’s brand new generative AI team, leveraging Python through Pytorch, Langchain, Django, and Flask
- Conducted research in Large Language Models (LLM) to develop applications for credit analysis and risk assessment
- Developed a legal co-pilot tool using Azure OpenAI, automating and assisting in legal procedures and documentation
...
- Generated synthetic dataset with Blender.py to train a computer vision model for placenta diagnosis before real life trials
- Developed software to effectively use the Polyga S1 camera to scan placentas and gather data for the real trials
